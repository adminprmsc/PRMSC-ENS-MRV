...
export class TubewellOperatorService {
  ...
  private waterSystemToJson(s: WaterSystem) {
    ...
    return {
      ...
      pump_serial_number: s.pumpSerialNumber,
      start_of_operation: toIsoDateString(s.startOfOperation),
      depth_of_water_intake: s.depthOfWaterIntake,
      height_to_ohr: s.heightToOhr,
      pump_flow_rate: s.pumpFlowRate,
